...
class STELLARIUMSHARED_EXPORT StelObjectMgr : public StelModule
{
	Q_OBJECT
...
///////////////////TODO: find list for square; for azimuthal spherical view;
...
//	bool findAndSelect(const StelCore* core, const Vec3d& pos, StelModule::StelModuleSelectAction action=StelModule::ReplaceSelection);
    ...
    //! my search function
    QList<StelObjectP> altAzFind(const StelCore* core, const double alt, const double az, const double fov, const float limitMag) const;
